...
* **Objects** - Objects are bundles of data (properties, attributes) that we can perform a behavior on with methods
* **Domain Modeling** - Object Relationships 
* **SQL** - SQL Structure query language: the language communicate with the DB
* **ORM** - Object Reltionship Mapping.
* **Active Record** - ORM
